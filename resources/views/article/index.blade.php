                                        ...
                                        <a href="{{ route('article.edit', ['id' => $article->id]) }}"
                                            ...
                                            <svg class="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                                                ...
                                                <path fill-rule="evenodd"
                                                    d="M8 11a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1zm-3-6a1 1 0 011-1h10a1 1 0 110 2H6a1 1 0 01-1-1zm0 4a1 1 0 011-1h10a1 1 0 110 2H6a1 1 0 01-1-1zm4 5a1 1 0 100 2h2a1 1 0 100-2H9z"
