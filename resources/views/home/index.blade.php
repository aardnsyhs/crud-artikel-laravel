    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Welcome to Article</h1>
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="/login"
                        ...
                        started</a>
                    <a href="/article" class="text-sm font-semibold leading-6 text-gray-900">Read articles <span
        ...
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            <div class="text-center">
                <a href="#"
                    ...
                    <span class="text-2xl text-normal"><span class="font-bold">Art</span>icle</span>
                </a>
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024 <a href="#"
                        class="hover:underline">Article&#8482;</a>. All Rights Reserved.
                </span>
